...
function oercurr_featured_slider_load_translations(){
	?>
	<script>
	document.addEventListener("DOMContentLoaded", function(event) {
		
		window.oercurr_cfb_global = {
			"locale": "<?php echo get_locale() ?>",
			"baseurl": "<?php echo get_home_url() ?>",
			"pluginurl": "<?php echo OERCURR_CURRICULUM_URL ?>",
			"plugindir": "<?php plugin_dir_path(__FILE__) ?>",
			"translations": {
				"Featured Curriculum Slider" : "Deslizador de Planes de estudio Destacados",
				"Use this block to add OER curriculum and resources in a slider" : "Utilice este bloque para añadir currículos y recursos REA en un deslizador",
				"Curriculum Featured Block Settings" : "Plan de estudios Configuración del Bloque Destacado",
				"Block Title" : "Título del bloque",
				"Block Width" : "Anchura del bloque",
				"Note: Block width setting is only used to simulate the frontend width at backend and will not affect the frontend" : "Nota: El ajuste de la anchura del bloque sólo se utiliza para simular la anchura del frontend en el backend y no afectará al frontend",
				"Featured List" : "Lista destacada",
				"Add Resources" : "Añadir recursos",
				"Add Curriculum" : "Añadir plan de estudios",
				"Slider Setting" : "Ajuste de la corredera",
				"Min. Slides" : "Min. Diapositivas",
				"MinSlideInfo" : "El número mínimo de diapositivas a mostrar. Las diapositivas se reducirán si el deslizador es más pequeño que el tamaño original",
				"Max. Slides" : "Max. Diapositivas",
				"MaxSlideInfo" : "El número máximo de diapositivas a mostrar. Las diapositivas se dimensionarán si el deslizador supera el tamaño original",
				"Move Slides" : "Mover diapositivas",
				"MoveSlidesInfo" : "El número de diapositivas a mover en la transición. Este valor debe ser mayor o igual que minSlides, y menor o igual que maxSlides. Si el valor es mayor que las diapositivas totalmente visibles, se utilizará el recuento de diapositivas totalmente visibles",
				"Slide Width" : "Anchura de la diapositiva",
				"SlideWidthInfo" : "Anchura de cada portaobjetos",
				"Slide Margin" : "Margen de deslizamiento",
				"SlideMarginInfo" : "Espacio entre diapositivas",
				"Description length" : "Descripción de la longitud",
				"DescriptionLengthInfo" : "Longitud de la descripción a mostrar",
				"Image height" : "Altura de la imagen",
				"ImageHeightInfo" : "Ajustar la altura de la imagen",
				"Resources" : "Recursos",
				"Curriculum" : "Plan de estudios",
				"Resources lists" : "Listas de recursos",
				"Curriculum lists" : "Listas de planes de estudio",
				"Filter by subject" : "Filtrar por tema",
				"Filter by search" : "Filtrar por búsqueda",
				"All" : "Todo"
			}
		}
		
		window.oercurr_cfb_t = function (txt){
			return (oercurr_cfb_global.locale == 'es_ES')? oercurr_cfb_global.translations[txt]: txt;
		}
...
add_action( 'admin_head', 'oercurr_featured_slider_load_translations');
add_action( 'wp_head', 'oercurr_featured_slider_load_translations');